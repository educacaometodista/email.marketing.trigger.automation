                            ...
                            <div class="m-account--form">
                                ...
                                <form action="{{ route('admin.login') }}" method="POST">
                                    ...
                                    <div class="m-account--footer">
                                        <p><a href="https://github.com/educacaometodista" target="_blank"><p><a href="https://github.com/educacaometodista" style="color:#745faa;" target="_blank">&copy; 2019 Educação Metodista</a></p></a></p>
                                    </div>
                                </form>
                            </div>
                        </div>
